...
var TableHead = (function (_React$Component) {
    ...
    _createClass(TableHead, [{
        ...
        value: function render() {
            ...
            _react2['default'].createElement('tr', null, this.props.columns.map(function (column, key) {
...
TableHead.propTypes = {
    sortedOn: _react2['default'].PropTypes.string,
    arrow: _react2['default'].PropTypes.string,
    columns: {
