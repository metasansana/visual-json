...
describe('Radio', function () {
    ...
    describe('Radio.render', function () {
        ...
        it('it should render the correct markup', function () {
            ...
            }))).toBe('<div class="form-group">' + '<label>Das Radio</label>' + '<div class="radio"><label><input name="sony" value="1" type="radio" class="">Option 1</label></div>' + '<div class="radio"><label><input name="sony" value="2" type="radio" class="">Option 2</label></div>' + '</div>');
        });
    });
});