...
var HorizontalRadio = (function (_Radio) {
    ...
    _createClass(HorizontalRadio, [{
        ...
        value: function renderComponent() {
            ...
            return _react2['default'].createElement('div', { className: 'form-group' + this.state.validationState }, _react2['default'].createElement('label', { className: 'col-' + bsSize + '-' + labelWidth }, this.props.labelValue), _react2['default'].createElement('div', { className: 'col-' + bsSize + '-' + controlWidth }, _Radio3['default'].renderComponent.call(this)));
        }
    }]);
