...
describe('Table', function () {
    ...
    describe('Table.render()', function () {
        ...
        it('should sort on heading click', function () {

            var props = {
                columns: [{ name: 'name', label: 'Name' }, { name: 'age', label: 'Age' }, { name: 'date', label: 'Date', sortAs: 'date' }],
                data: [{ name: 'D', age: 1, date: new Date('01/01/2001') }, { name: 'A', age: 3, date: new Date('01/01/2009') }, { name: 'C', age: 1, date: new Date('03/08/2001') }, { name: 'B', age: 7, date: new Date('07/24/1902') }]
